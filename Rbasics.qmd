...
knitr::include_graphics('img/for_loop_flow_chart.png')
```
...
```{r, fig.align='center', echo=FALSE, out.width='50%'}
knitr::include_graphics('img/while_loop_flow_chart.png')
```
...
```{r, fig.align='center', echo=FALSE, out.width='50%'}
knitr::include_graphics('img/repeat_loop_flow_chart.png')
```
