...
A common trip up for novices occurs when trying to skip slices of a vector. It's natural to try to negate a sequence like so, but this gives a somewhat cryptic error message:
...
![](img/06-rmd-inequality.1.png){alt="Inequality testing"}

When one vector is shorter than the other, it gets *recycled*:

![](img/06-rmd-inequality.2.png){alt="Inequality testing: results of recycling"}
...
download.file(paste0(root_srcfile,"data/gapminder_data.csv"),
              "gapminder_data.csv")
