...
The data is posted daily to a [url as a zip file]({{ site.baseurl }}/data/individual_collar_data.zip) that contains one csv file for each individual: [data/individual_collar_data.zip](data/individual_collar_data.zip)
